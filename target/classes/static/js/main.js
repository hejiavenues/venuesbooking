var vm = new Vue({
  ...
  methods: {
    ...
    loadMain: function() {
      ...
      zs_post({
        ...
        success: function(data) {
          ...
          _this.msg.credit = m.creditSuccess == 0 ? 0 : parseInt((m.creditSuccess / m.creditSum) * 100);
          _this.bigEchart0(m);
        }
      });
    },
    ...
    bigEchart0: function(a) {
      ...
      var xArr = this.$t("ec1");
      var xdata = [a.clickSum, a.mobileSum, a.creditSum, a.creditSuccess, a.decisionSum, a.riskSuccess, a.dtSum, a.waitDt, a.dtSuccess, a.dtFail, a.waitDt2, a.dt2Success, a.dt2Fail, a.tradeSuccess, a.tradeFail, a.repaymentSum, a.repaidSum];
      option = {
        color: ['#3398DB'],
        tooltip: {
          trigger: 'axis',
