...
public class SecurityUtil {
	public static final String pass = "3.14159265358979";
...
//		String PWD = "SecurityUtil.PWD";
		...
		System.out.println("base64加密:[" + strBase64.length() + "]" + strBase64);
		System.out.println("base64解密:" + Base64Decode(strBase64));
		System.out.println("==Aes============");
		String strAes = AesEncrypt(str, PWD);
		System.out.println("aes加密:[" + strAes.length() + "]" + strAes);
		System.out.println("aes解密:" + AesDecrypt(strAes, PWD));
		System.out.println("==Des==============");
		String strDes = desEncrypt(str, PWD);
		System.out.println("des加密:[" + strDes.length() + "]" + strDes);
		System.out.println("des解密:" + desDecrypt(strDes, PWD));
		System.out.println("==3Des==============");
		String str3Des = threeDesEncrypt(str, PWD);
		System.out.println("3des加密:[" + str3Des.length() + "]" + str3Des);
		System.out.println("3des解密:" + threeDesDecrypt(str3Des, PWD));
