...
import cn.cashbang.core.common.constant.SystemConstant.MenuType;
...
public class SysMenuManagerImpl implements SysMenuManager {
	...
	@Override
	public List<SysMenuEntity> listMenuByManager(Query search) {
		return sysMenuMapper.listByManager(search);
	}
