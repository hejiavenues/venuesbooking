 ...
 */
(function () {
    var TreeTable_sm = function (tableId, url, columns) {
        this.btInstance = null;					//jquery和bootstrapTreeTable绑定的对象
        this.bstableId = tableId;
        this.url = url;
        this.method = "GET";
    ...
    TreeTable_sm.prototype = {
        ...
        refresh: function (parms) {
            if (typeof parms != "undefined") {
                this.btInstance.bootstrapTreeTable_sm('refresh', parms.query);// 为了兼容bootstrap-table的写法
            } else {
                this.btInstance.bootstrapTreeTable_sm('refresh');
            }
        },
        ...
        resetHeight: function(parms) {
        	if (typeof parms != "undefined") {
                this.btInstance.bootstrapTreeTable_sm('resetHeight', parms.height);// 为了兼容bootstrap-table的写法
            } else {
                this.btInstance.bootstrapTreeTable_sm('resetHeight');
            }
        },
         ...
         */
        getSelectedRow: function() {
            return this.btInstance.bootstrapTreeTable_sm('getSelections');
        }
    };

    window.TreeTable_sm = TreeTable_sm;
